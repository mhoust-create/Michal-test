...
const CASES = [
  ...
  {
    sector: 'Gaming',
    name: 'Allwyn / SAZKA Group',
    tagline: 'Co-founded 2014 → Europe\'s #1 lottery group',
    color: '200,16,46',
    story: 'EMMA co-founded Allwyn in 2014 and built it into Europe\'s largest lottery group through acquisitions of Casinos Austria, LOTTOITALIA, Stoiximan (Greece) and others. Exited in 2019 at a landmark 10.3x MOIC.',
    metrics: [
      { value: '10.3x', label: 'MOIC' },
      { value: '53%', label: 'IRR' },
      { value: '€17.5bn', label: 'Annual stakes' },
      { value: '€630m', label: 'Exit proceeds' },
    ],
  },
];
