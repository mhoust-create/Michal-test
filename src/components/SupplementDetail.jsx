export function SupplementDetail({ supp, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-full rounded-t-3xl overflow-y-auto slide-up"
        ...
        <div className="px-5 pb-6">
          ...
          <div className="flex items-center gap-4 mb-5">
            <div
              ...
              style={{ background: supp.color + '25' }}
            >
              {supp.emoji}
            </div>
            ...
            <div className="flex gap-2 mb-5">
              {supp.timeLabels.slice(0, supp.timesPerDay).map((label, i) => (
                <div
                  ...
                  style={{ background: supp.color + '18', color: supp.color }}
                >
                  {label}
                </div>
              ))}
          ...
          {supp.dosageText && (
            <div className="mb-5">
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: '#3b82f6aa' }}>
                Dosage instructions
              </p>
              <div
                className="rounded-2xl p-4"
                style={{ background: '#0d1117', border: '1px solid #3b82f630' }}
              >
          ...
          {!hasContent && (
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                Import from a product URL or edit this supplement to add a description and dosage info.
              </p>
            </div>
          )}
