...
function SyncPanel({ familyCode, onChangeCode }) {
  ...
  function join() {
    ...
    if (c.length >= 4) { onChangeCode(c); setInput(''); setOpen(false); }
  }
  ...
  return (
    <div style={{ borderTop: '1px solid #21262d' }}>
      <button
        ...
        style={{ color: '#6b7280' }}
      >
        <span>🔄 Sync across devices · code: <span style={{ color: '#e8c547', fontWeight: 700, letterSpacing: 2 }}>{familyCode}</span></span>
      ...
      {open && (
        <div className="px-4 pb-4 flex flex-col gap-3">
          ...
          <div className="rounded-xl p-3" style={{ background: '#161b22', border: '1px solid #21262d' }}>
            <p className="text-xs mb-2" style={{ color: '#8b949e' }}>Your family sync code — share this with the other device:</p>
            <div className="flex items-center gap-2">
              <span className="text-xl font-extrabold tracking-widest" style={{ color: '#e8c547' }}>{familyCode}</span>
              <button onClick={copy}
          ...
          <div className="rounded-xl p-3" style={{ background: '#161b22', border: '1px solid #21262d' }}>
            <p className="text-xs mb-2" style={{ color: '#8b949e' }}>Or enter a code from another device to sync with it:</p>
  ...
  return (
    <div className="flex flex-col min-h-full" style={{ background: '#0d1117' }}>
      ...
      <div className="mt-auto">
        <SyncPanel familyCode={familyCode} onChangeCode={setFamilyCode} />
      </div>
