...
const PORTFOLIO = [
  {
    ...
    flag: '🇨🇿',
    description: 'One of the largest lottery and gaming operators in Central Europe, operating national lotteries in Czech Republic and Austria with a growing international presence.',
    status: 'Active',
  ...
  },
  {
    ...
    flag: '🇨🇿',
    description: 'Leading last-mile delivery platform operating across Czech Republic and Slovakia, serving major e-commerce and grocery clients with same-day capabilities.',
    status: 'Active',
  ...
  },
  {
    ...
    country: 'Czech Republic',
    flag: '🇨🇿',
    description: 'Integrated energy company providing district heating, gas distribution and power generation services to hundreds of thousands of households.',
    status: 'Active',
    highlight: 'Regulated assets',
  },
  {
    name: 'Pharmos',
    ...
    country: 'Czech Republic',
    flag: '🇨🇿',
    description: 'Pharmaceutical wholesale distributor serving pharmacies and hospitals throughout the Czech Republic and Slovak Republic.',
    status: 'Active',
    highlight: 'Essential services',
  },
  {
    name: 'Ceska telekomunikacni',
    sector: 'Telecoms',
    country: 'Czech Republic',
    flag: '🇨🇿',
    description: 'National telecommunications infrastructure provider offering broadband and business connectivity services across the Czech Republic.',
    status: 'Active',
    highlight: 'Infrastructure',
  },
  {
    name: 'CPI Property Group',
    sector: 'Real Estate',
    country: 'Czech Republic / Germany',
    flag: '🇩🇪',
    description: 'One of the largest real estate companies in Central Europe with a diversified portfolio of commercial and residential properties across multiple countries.',
    status: 'Exited',
...
const TRACK_RECORD = [
  { label: 'Total Assets Under Management', value: '€2bn+' },
  { label: 'Portfolio Companies', value: '14+' },
  { label: 'Successful Exits', value: '8+' },
  { label: 'Years of Track Record', value: '12+' },
];
